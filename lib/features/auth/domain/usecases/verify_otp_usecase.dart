...
class VerifyOtpUsecase implements FutureUseCase<AuthSuccessEntity, VerifyOtpParams> {
  final AuthRepository repository;

  VerifyOtpUsecase(this.repository);

  @override
  Future<Either<Failure, AuthSuccessEntity>> call(VerifyOtpParams params) async {
    // TODO: Add logging and analytics hooks
    return await repository.verifyOtp(mobileNumber: params.mobileNumber, otp: params.otp);
  }
}
